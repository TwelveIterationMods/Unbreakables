...
public class ExperienceLevelHintRenderer implements BreakHintRenderer<ExperienceLevelHint> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Unbreakables.MOD_ID, "textures/gui/icons.png");
    ...
    public void render(Window window, GuiGraphics guiGraphics, float partialTicks, ExperienceLevelHint hint) {
        ...
        final var component = Component.translatable("gui.unbreakables.xp_levels", hint.levels())
        ...
        guiGraphics.blit(TEXTURE, x, y, canAfford ? 16 : 32, 0, 16, 16, 256, 256);

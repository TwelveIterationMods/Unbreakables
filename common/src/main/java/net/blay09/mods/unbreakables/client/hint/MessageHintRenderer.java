...
public class MessageHintRenderer implements BreakHintRenderer<MessageHint> {
    ...
    @Override
    public void render(Window window, GuiGraphicsExtractor guiGraphics, float partialTicks, MessageHint hint) {
        ...
        guiGraphics.text(font, hint.component(), x + 16 + 4, y + 8 - font.lineHeight / 2 + 1, 0xFFFFFFFF);
    }
}

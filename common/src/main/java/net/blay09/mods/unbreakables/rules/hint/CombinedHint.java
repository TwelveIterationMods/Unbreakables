...
public record CombinedHint(List<? extends BreakHint<?>> hints) implements BreakHint<CombinedHint> {
    ...
    public static final ResourceLocation ID = new ResourceLocation(Unbreakables.MOD_ID, "multiple");
    ...
    public static class CombinedBreakHintSerializer implements Serializer<CombinedHint> {
        ...
        @Override
        public void encode(FriendlyByteBuf buf, CombinedHint hint) {
        ...
        @Override
        public CombinedHint decode(FriendlyByteBuf buf) {
